    ...
    <div className="min-h-screen flex flex-col text-white">
      <main className="container mx-auto px-6 pt-16 flex-1 text-center">
        ...
        <div className="text-lg md:text-2xl lg:text-3xl py-2 px-4 md:py-4 md:px-10 lg:py-6 lg:px-12 bg-white bg-opacity-10 w-fit mx-auto mb-8 rounded-full">
          There are more than 63,000 programmers all across the UAE !
        </div>

        <form 
					action="https://ai.gov.ae/codershq/" 
					method="post" 
					id="revue-form"
					name="revue-form"
					target="_blank">
      ...
      <footer className="container mx-auto p-6 flex flex-col md:flex-row items-center justify-between">
        <p>Buit by Helal Salem</p>

        <div className="flex -mx-6">
          <a href="#" className="mx-3 hover:opacity-80 duratuion-150">About us</a>|
          <a href="" className="mx-3 hover:opacity-80 duratuion-150">Contact</a>
